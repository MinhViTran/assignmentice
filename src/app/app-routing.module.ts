...
const routes: Routes = [
  ...
  { path: 'aboutUs/aflAdmin', component: AflAdminComponent },
  { path: 'aboutUs/aflRules', component: AflRulesComponent },
  { path: 'aboutUs/aflAdmin/aflRules', component: AflRulesComponent },
  { path: 'aboutUs/aflAdmin/aboutUs', component: AboutUsComponent },
